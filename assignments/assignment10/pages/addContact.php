...
if(!isset($_SESSION['access']) || (isset($_SESSION['access']) && ($_SESSION['access'] !== "accessGranted"))){
...
$elementsArr = [
  "masterStatus"=>[
    ...
    "address"=>[
        "errorMessage"=>"<span style='color: red; margin-left: 15px;'>(just numbers and street)</span>",
      "errorOutput"=>"",
      "type"=>"text",
      ...
      "city"=>[
        "errorMessage"=>"<span style='color: red; margin-left: 15px;'>City cannot be blank and must use valid characters</span>",
      "errorOutput"=>"",
      "type"=>"text",
      "value"=>"Ann Arbor",
          "regex"=>"city"
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      $sql = "INSERT INTO contacts (name, address, city, state, phone, email, contacts, dob, age) VALUES (:name, :address, :city, :state, :phone, :email, :contacts, :dob, :age)";
...
$form = <<<HTML
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contacts[]" id="contact1" value="newsletter" {$elementsArr['contacts']['value']['newsletter']}>
      <label class="form-check-label" for="contact1">Newsletter</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contacts[]" id="contact2" value="email" {$elementsArr['contacts']['value']['email']}>
      <label class="form-check-label" for="contact2">Email Updates</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contacts[]" id="contact3" value="text" {$elementsArr['contacts']['value']['text']}>
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="age" id="age1" value="10-18"  {$elementsArr['age']['status']['10-18']}>
      <label class="form-check-label" for="age1">10-18</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="age" id="age2" value="19-30"  {$elementsArr['age']['status']['19-30']}>
      <label class="form-check-label" for="age2">19-30</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="age" id="age3" value="30-50"  {$elementsArr['age']['status']['30-50']}>
      <label class="form-check-label" for="age3">30-50</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="age" id="age4" value="51+"  {$elementsArr['age']['status']['51+']}>
